...
import com.mycompany.biblioteca.servicios.UsuarioServicio;
...
public class PortalControlador {
    ...
    public String registrar(){
     ...
     public String registro(@RequestParam String nombre, String email, 
    ...
    public String login(@RequestParam(required = false) String error, ModelMap modelo){
        ...
        if(error != null){
            modelo.put("error", "Usuario o contraseña inválida");
        }
        return "login.html";
    }
